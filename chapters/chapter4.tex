...
\ref{fig: thz_subs} shows the UV-Vis transmittance spectra of a\qty{600}{\nano\meter} a-Si thin film deposited on a glass substrate together with the upper and lower envelopes as calculated using the Swanepoel method. The equations of the exponential function fitted to the extrema points listed in \ref{tab: thickness_SiO2} are $y = 78.883769-36568844000e^{-x/78.107899}+36569328000e^{-x/78.107726}$ for the maxima with $R^2 = 0.9993$ and $y = 47.724-26240.8545e^{-x/95.06845}+3853071.68e^{-x/47.41479}$ for the minima with $R^2 = 1$. The refractive index of the a-Si thin film ranges from $3.065$ to $3.089$ in the wavelength range of \qty{1002}{\nano\meter} to \qty{709}{\nano\meter}. The average thickness of the a-Si thin film according to the Swanepoel method is \qty{640}{\nano\meter}.
